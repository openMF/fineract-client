...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            List<GetCachesResponse> result = apiInstance.retrieveAll4();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CacheApi#retrieveAll4");
...
> PutCachesResponse switchCache(putCachesRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        CacheApi apiInstance = new CacheApi(defaultClient);
        PutCachesRequest putCachesRequest = new PutCachesRequest(); // PutCachesRequest | 
        try {
            PutCachesResponse result = apiInstance.switchCache(putCachesRequest);
            System.out.println(result);
        } catch (ApiException e) {
