...
public class Example {
    public static void main(String[] args) {
        ...
        PostCodesRequest postCodesRequest = new PostCodesRequest(); // PostCodesRequest | 
        try {
            PostCodesResponse result = apiInstance.createCode(postCodesRequest);
...
> PutCodesResponse updateCode(codeId, putCodesRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        CodesApi apiInstance = new CodesApi(defaultClient);
        Long codeId = 56L; // Long | codeId
        PutCodesRequest putCodesRequest = new PutCodesRequest(); // PutCodesRequest | 
        try {
            PutCodesResponse result = apiInstance.updateCode(codeId, putCodesRequest);
            System.out.println(result);
        } catch (ApiException e) {
