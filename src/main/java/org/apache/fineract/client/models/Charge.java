...
public class Charge {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, amount, currencyCode, chargeTimeType, chargeCalculation, chargePaymentMode, feeInterval, penalty, active, deleted, minCap, maxCap, account, taxGroup, allowedClientChargeCalculationType, allowedSavingsChargeCalculationType, percentageOfDisbursementAmount, disbursementCharge, percentageOfApprovedAmount, savingsCharge, feeOnMonthDay, allowedSavingsChargeTime, allowedClientChargeTime, allowedLoanChargeTime, clientCharge, loanCharge, monthlyFee, overdueInstallment, annualFee, _new);
  }
