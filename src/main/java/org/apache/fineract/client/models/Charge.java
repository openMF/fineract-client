...
public class Charge {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, amount, currencyCode, chargeTimeType, chargeCalculation, chargePaymentMode, feeInterval, penalty, active, deleted, minCap, maxCap, account, taxGroup, feeOnMonthDay, annualFee, monthlyFee, savingsCharge, allowedSavingsChargeCalculationType, allowedClientChargeCalculationType, percentageOfDisbursementAmount, loanCharge, clientCharge, allowedLoanChargeTime, allowedClientChargeTime, allowedSavingsChargeTime, percentageOfApprovedAmount, overdueInstallment, disbursementCharge, _new);
  }
