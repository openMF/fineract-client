...
public class Client {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, office, transferToOffice, image, status, firstname, middlename, lastname, displayName, mobileNo, emailAddress, externalId, staff, groups, accountNumberRequiresAutoGeneration, closureDate, withdrawalDate, submittedOnDate, legalForm, reopenedDate, proposedTransferDate, active, closed, rejectedDate, notStaff, rejected, pending, transferInProgressOrOnHold, officeJoiningLocalDate, notActive, notPending, withdrawn, transferOnHold, transferInProgress, activationLocalDate, _new);
  }
