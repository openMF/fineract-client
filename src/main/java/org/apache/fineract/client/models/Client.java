...
public class Client {
  ...
  private Date officeJoiningLocalDate;
  ...
  **/
  ...
  public Client closureDate(Date closureDate) {
  ...
  **/
  ...
  public Client withdrawalDate(Date withdrawalDate) {
  ...
  **/
  ...
  public Client submittedOnDate(Date submittedOnDate) {
  ...
  **/
  ...
  public Client reopenedDate(Date reopenedDate) {
  ...
  **/
  ...
  public Client proposedTransferDate(Date proposedTransferDate) {
  ...
  **/
  ...
  public void setProposedTransferDate(Date proposedTransferDate) {
    this.proposedTransferDate = proposedTransferDate;
  }
  ...
  **/
  ...
  public Client officeJoiningLocalDate(Date officeJoiningLocalDate) {
  ...
  **/
  ...
  public Date getOfficeJoiningLocalDate() {
    return officeJoiningLocalDate;
  }


  public void setOfficeJoiningLocalDate(Date officeJoiningLocalDate) {
    this.officeJoiningLocalDate = officeJoiningLocalDate;
  }
  ...
  **/
  ...
  public Client rejectedDate(Date rejectedDate) {
  ...
  **/
  ...
  public Client activationLocalDate(Date activationLocalDate) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, office, transferToOffice, image, status, firstname, middlename, lastname, displayName, mobileNo, emailAddress, externalId, staff, groups, accountNumberRequiresAutoGeneration, closureDate, withdrawalDate, submittedOnDate, legalForm, reopenedDate, proposedTransferDate, transferInProgress, transferOnHold, notPending, transferInProgressOrOnHold, notActive, closed, active, rejected, pending, officeJoiningLocalDate, notStaff, withdrawn, rejectedDate, activationLocalDate, _new);
  }
