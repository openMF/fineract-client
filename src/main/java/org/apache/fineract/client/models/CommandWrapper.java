...
public class CommandWrapper {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(groupId, clientId, loanId, savingsId, entityName, taskPermissionName, entityId, subentityId, href, json, transactionId, productId, creditBureauId, organisationCreditBureauId, update, registerDatatable, noteResource, delete, surveyResource, registerSurvey, fullFilSurvey, loanDisburseDetailResource, updateDisbursementDate, datatableResource, deleteOperation, updateOperation, userResource, permissionResource, currencyResource, cacheResource, workingDaysResource, passwordPreferencesResource, create, createDatatable, deleteDatatable, updateDatatable, deleteOneToOne, deleteMultiple, updateOneToOne, updateMultiple);
  }
