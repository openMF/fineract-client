...
public class GetFixedDepositAccountsStatus {
  ...
  public GetFixedDepositAccountsStatus id(Integer id) {
  ...
  **/
  ...
  public GetFixedDepositAccountsStatus code(String code) {
  ...
  **/
  ...
  public GetFixedDepositAccountsStatus description(String description) {
  ...
  **/
  ...
  public GetFixedDepositAccountsStatus submittedAndPendingApproval(Boolean submittedAndPendingApproval) {
  ...
  **/
  ...
  public GetFixedDepositAccountsStatus approved(Boolean approved) {
  ...
  **/
  ...
  public GetFixedDepositAccountsStatus rejected(Boolean rejected) {
  ...
  **/
  ...
  public GetFixedDepositAccountsStatus withdrawnByApplicant(Boolean withdrawnByApplicant) {
  ...
  **/
  ...
  public GetFixedDepositAccountsStatus active(Boolean active) {
  ...
  **/
  ...
  public GetFixedDepositAccountsStatus closed(Boolean closed) {
  ...
  **/
  ...
  public GetFixedDepositAccountsStatus prematureClosed(Boolean prematureClosed) {
  ...
  **/
  ...
  public GetFixedDepositAccountsStatus transferInProgress(Boolean transferInProgress) {
  ...
  **/
  ...
  public GetFixedDepositAccountsStatus transferOnHold(Boolean transferOnHold) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetFixedDepositAccountsStatus getFixedDepositAccountsStatus = (GetFixedDepositAccountsStatus) o;
    return Objects.equals(this.id, getFixedDepositAccountsStatus.id) &&
        Objects.equals(this.code, getFixedDepositAccountsStatus.code) &&
        Objects.equals(this.description, getFixedDepositAccountsStatus.description) &&
        Objects.equals(this.submittedAndPendingApproval, getFixedDepositAccountsStatus.submittedAndPendingApproval) &&
        Objects.equals(this.approved, getFixedDepositAccountsStatus.approved) &&
        Objects.equals(this.rejected, getFixedDepositAccountsStatus.rejected) &&
        Objects.equals(this.withdrawnByApplicant, getFixedDepositAccountsStatus.withdrawnByApplicant) &&
        Objects.equals(this.active, getFixedDepositAccountsStatus.active) &&
        Objects.equals(this.closed, getFixedDepositAccountsStatus.closed) &&
        Objects.equals(this.prematureClosed, getFixedDepositAccountsStatus.prematureClosed) &&
        Objects.equals(this.transferInProgress, getFixedDepositAccountsStatus.transferInProgress) &&
        Objects.equals(this.transferOnHold, getFixedDepositAccountsStatus.transferOnHold);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFixedDepositAccountsStatus {\n");
