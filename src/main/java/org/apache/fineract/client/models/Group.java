...
public class Group {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, office, staff, parent, groupLevel, groupMembers, clientMembers, submittedOnDate, accountNumberRequiresAutoGeneration, closed, active, pending, group, center, activationLocalDate, transferInProgress, transferOnHold, notPending, transferInProgressOrOnHold, childGroup, activeClientMembers, notActive, _new);
  }
