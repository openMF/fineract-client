...
public class Group {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, office, staff, parent, groupLevel, groupMembers, clientMembers, submittedOnDate, accountNumberRequiresAutoGeneration, active, closed, pending, group, transferInProgressOrOnHold, center, notActive, activeClientMembers, childGroup, notPending, transferOnHold, transferInProgress, activationLocalDate, _new);
  }
