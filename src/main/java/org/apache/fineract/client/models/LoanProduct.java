...
public class LoanProduct {
  ...
  **/
  ...
  public LoanProduct startDate(Date startDate) {
  ...
  **/
  ...
  public LoanProduct closeDate(Date closeDate) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, shortName, rates, loanProductRelatedDetail, includeInBorrowerCycle, startDate, closeDate, externalId, minimumDaysBetweenDisbursalAndFirstRepayment, productInterestRecalculationDetails, loanProductGuaranteeDetails, principalThresholdForLastInstallment, installmentAmountInMultiplesOf, floatingRates, syncExpectedWithDisbursementDate, currency, holdGuaranteeFundsEnabled, equalAmortization, arrearsBasedOnOriginalSchedule, accountingDisabled, principalAmount, minPrincipalAmount, maxPrincipalAmount, loanProductConfigurableAttributes, linkedToFloatingInterestRate, repaymentStrategy, loanProductCharges, cashBasedAccountingEnabled, accrualBasedAccountingEnabled, numberOfRepayments, nominalInterestRatePerPeriod, interestPeriodFrequencyType, minNumberOfRepayments, maxNumberOfRepayments, accountingType, interestRecalculationEnabled, multiDisburseLoan, upfrontAccrualAccountingEnabled, periodicAccrualAccountingEnabled, minNominalInterestRatePerPeriod, maxNominalInterestRatePerPeriod, _new);
  }
