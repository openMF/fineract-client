...
public class LoanProduct {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, shortName, rates, loanProductRelatedDetail, includeInBorrowerCycle, startDate, closeDate, externalId, minimumDaysBetweenDisbursalAndFirstRepayment, productInterestRecalculationDetails, loanProductGuaranteeDetails, principalThresholdForLastInstallment, installmentAmountInMultiplesOf, floatingRates, syncExpectedWithDisbursementDate, currency, multiDisburseLoan, accountingType, nominalInterestRatePerPeriod, interestPeriodFrequencyType, numberOfRepayments, interestRecalculationEnabled, repaymentStrategy, loanProductCharges, loanProductConfigurableAttributes, accountingDisabled, upfrontAccrualAccountingEnabled, periodicAccrualAccountingEnabled, principalAmount, minPrincipalAmount, maxPrincipalAmount, minNominalInterestRatePerPeriod, maxNominalInterestRatePerPeriod, minNumberOfRepayments, maxNumberOfRepayments, holdGuaranteeFundsEnabled, arrearsBasedOnOriginalSchedule, equalAmortization, cashBasedAccountingEnabled, accrualBasedAccountingEnabled, linkedToFloatingInterestRate, _new);
  }
