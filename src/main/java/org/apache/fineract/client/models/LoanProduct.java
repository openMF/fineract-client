...
public class LoanProduct {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, shortName, rates, loanProductRelatedDetail, includeInBorrowerCycle, startDate, closeDate, externalId, minimumDaysBetweenDisbursalAndFirstRepayment, productInterestRecalculationDetails, loanProductGuaranteeDetails, principalThresholdForLastInstallment, installmentAmountInMultiplesOf, floatingRates, syncExpectedWithDisbursementDate, holdGuaranteeFundsEnabled, arrearsBasedOnOriginalSchedule, equalAmortization, accountingDisabled, upfrontAccrualAccountingEnabled, periodicAccrualAccountingEnabled, principalAmount, minPrincipalAmount, maxPrincipalAmount, minNominalInterestRatePerPeriod, maxNominalInterestRatePerPeriod, minNumberOfRepayments, maxNumberOfRepayments, loanProductCharges, loanProductConfigurableAttributes, repaymentStrategy, linkedToFloatingInterestRate, interestRecalculationEnabled, multiDisburseLoan, currency, nominalInterestRatePerPeriod, interestPeriodFrequencyType, numberOfRepayments, cashBasedAccountingEnabled, accrualBasedAccountingEnabled, accountingType, _new);
  }
