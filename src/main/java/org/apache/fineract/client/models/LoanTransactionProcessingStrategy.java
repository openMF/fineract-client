...
public class LoanTransactionProcessingStrategy {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, creocoreStrategy, indianRBIStrategy, earlyPaymentStrategy, standardStrategy, heavensfamilyStrategy, principalInterestPenaltiesFeesOrderStrategy, interestPrincipalPenaltiesFeesOrderStrategy, _new);
  }
