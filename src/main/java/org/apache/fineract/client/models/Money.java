...
public class Money {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currencyCode, currencyDigitsAfterDecimal, amount, greaterThanZero, lessThanZero, amountDefaultedToNullIfZero, currency, zero, currencyInMultiplesOf);
  }
