 ...
 */
@ApiModel(description = "PostLoansLoanIdCollateralsRequest")

public class PostLoansLoanIdCollateralsRequest {
  public static final String SERIALIZED_NAME_COLLATERAL_TYPE_ID = "collateralTypeId";
  @SerializedName(SERIALIZED_NAME_COLLATERAL_TYPE_ID)
