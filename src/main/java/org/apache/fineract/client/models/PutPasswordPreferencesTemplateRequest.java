 ...
 */
@ApiModel(description = "PutPasswordPreferencesTemplateRequest")

public class PutPasswordPreferencesTemplateRequest {
  public static final String SERIALIZED_NAME_VALIDATION_POLICY_ID = "validationPolicyId";
  @SerializedName(SERIALIZED_NAME_VALIDATION_POLICY_ID)
