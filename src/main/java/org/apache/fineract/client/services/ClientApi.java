...
public interface ClientApi {
    ...
    PostClientsClientIdResponse activate1(
    ...
    String retrieveTransferTemplate(
            @retrofit2.http.Path("clientId") Long clientId
    );
    ...
    PutClientsClientIdResponse update10(
