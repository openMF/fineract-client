...
public interface FixedDepositAccountApi {
  ...
  Observable<DeleteFixedDepositAccountsAccountIdResponse> delete14(
  ...
  Completable getFixedDepositTemplate(
  ...
  Completable getFixedDepositTransactionTemplate(
  ...
  Observable<PostFixedDepositAccountsAccountIdResponse> handleCommands4(
  ...
  Observable<List<GetFixedDepositAccountsResponse>> retrieveAll29(
  ...
  Observable<GetFixedDepositAccountsAccountIdResponse> retrieveOne18(
  ...
  Observable<GetFixedDepositAccountsTemplateResponse> template12(
  ...
  Observable<PutFixedDepositAccountsAccountIdResponse> update15(
