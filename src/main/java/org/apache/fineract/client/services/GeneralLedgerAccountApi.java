...
public interface GeneralLedgerAccountApi {
  ...
  @POST("glaccounts")
  Observable<PostGLAccountsResponse> createGLAccount1(
  ...
  Observable<DeleteGLAccountsRequest> deleteGLAccount1(
  ...
  Observable<PutGLAccountsResponse> updateGLAccount1(
