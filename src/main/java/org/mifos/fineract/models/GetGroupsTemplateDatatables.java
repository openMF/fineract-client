...
public class GetGroupsTemplateDatatables {
    ...
    private List<GetGroupsTemplateColumnHeaderData> columnHeaderData = null;
    ...
    public GetGroupsTemplateDatatables columnHeaderData(List<GetGroupsTemplateColumnHeaderData> columnHeaderData) {
    ...
    public GetGroupsTemplateDatatables addColumnHeaderDataItem(GetGroupsTemplateColumnHeaderData columnHeaderDataItem) {
        if (this.columnHeaderData == null) {
            this.columnHeaderData = new ArrayList<GetGroupsTemplateColumnHeaderData>();
        }
    ...
    public List<GetGroupsTemplateColumnHeaderData> getColumnHeaderData() {
        return columnHeaderData;
    }

    public void setColumnHeaderData(List<GetGroupsTemplateColumnHeaderData> columnHeaderData) {
        this.columnHeaderData = columnHeaderData;
    }
