...
public interface DataTablesApi {
    ...
    Observable<DeleteDataTablesDatatableAppTableIdDatatableIdResponse> deleteDatatableEntries(
    ...
    Observable<DeleteDataTablesDatatableAppTableIdResponse> deleteDatatableEntries_0(
    ...
    Observable<GetDataTablesAppTableIdResponse> getDatatable(
    ...
    Observable<GetDataTablesResponse> getDatatable_0(
            @retrofit2.http.Path("datatable") String datatable
    );
