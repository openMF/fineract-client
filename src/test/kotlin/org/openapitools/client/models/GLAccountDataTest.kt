...
class GLAccountDataTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GLAccountData
        //val modelInstance = GLAccountData()
        ...
        // to test the property `incomeHeaderAccountOptions`
        should("test incomeHeaderAccountOptions") {
            // uncomment below to test the property
            //modelInstance.incomeHeaderAccountOptions shouldBe ("TODO")
        }
