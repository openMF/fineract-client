...
class GetAccountsSummaryTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetAccountsSummary
        //val modelInstance = GetAccountsSummary()
        ...
        // to test the property `totalApprovedShares`
        should("test totalApprovedShares") {
            // uncomment below to test the property
            //modelInstance.totalApprovedShares shouldBe ("TODO")
        }

        // to test the property `totalPendingForApprovalShares`
        should("test totalPendingForApprovalShares") {
            // uncomment below to test the property
            //modelInstance.totalPendingForApprovalShares shouldBe ("TODO")
        }
