...
class GetRecurringDepositAccountsAccountIdResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetRecurringDepositAccountsAccountIdResponse
        //val modelInstance = GetRecurringDepositAccountsAccountIdResponse()
        ...
        // to test the property `expectedFirstDepositOnDate`
        should("test expectedFirstDepositOnDate") {
            // uncomment below to test the property
            //modelInstance.expectedFirstDepositOnDate shouldBe ("TODO")
        }
